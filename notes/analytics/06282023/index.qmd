...
Distribution of sample means is approximately Normal, regardless of the population parameter's distribution given a large sample size.
:::

# Standard Error of the Mean

**Standard error** measures the variability of our estimate. Compare to the sample standard deviation which is a measure of the **variability in your data**.
...
6. If p-value $\leq \alpha$, reject $H_0$ and fail to reject otherwise
...
Testing a mean against a hypothesized value. We first need to calculate the t-statistic:
